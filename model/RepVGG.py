...
class RepVGGBlock(nn.Module):
    ...
    def setup(self) -> None:
        self.conv_3x3 = nn.Conv(self.channels, (3, 3), (self.strides, self.strides), padding=((1, 1), (1, 1)),
                                name='conv_3x3',
                                use_bias=False,
                                dtype=self.dtype)
        ...
        self.conv_deploy = nn.Conv(self.channels, (3, 3), (self.strides, self.strides), padding=((1, 1), (1, 1)),
    ...
    def __call__(self, x, *args, **kwargs):
        if self.deploy:
            ...
            x = self.bn_3x3(self.conv_3x3(x), ) + self.bn_1x1(self.conv_1x1(x)) + identity_out
        # x = self.bn_3x3(self.conv_3x3(x), ) + self.bn_1x1(self.conv_1x1(x))  # + identity_out
